...
- Upstream: `getodk/central` — this branch targets `v2026.1.2-vg.1`
  - **Client** (`drguptavivek/central-frontend`): `v2026.1.2` merge branch — based on upstream `v2026.1.2` (2026-05-01)
  - **Server** (`drguptavivek/central-backend`): `v2026.1.1-vg.1` plus VG Data Manager/migration fixes — based on upstream `v2026.1.1` (2026-04-07)
